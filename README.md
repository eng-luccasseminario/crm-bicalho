...
- 🔗 **Ponte Drive ↔ CRM**: cada documento arquivado vira **Nota** (aba Notes) vinculada à Empresa e à Proposta ativa, e a Empresa ganha o campo **"Pasta no Drive"** que abre a pasta organizada (com `npm run sync:crm` para o histórico).
